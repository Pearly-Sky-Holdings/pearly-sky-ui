...
const moveInAndOutTransportBookingCart: React.FC<SanitizationBookingCartProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5 mt-5">
      ...
      <div>
          <label className="block mb-2 text-blue-900">Location From</label>
          <input
            type="text"
            value={locationFrom}
            onChange={(e) => setLocationFrom(e.target.value)}
            className="w-full p-2 border border-blue-900 rounded-md text-center text-black" />
        </div>
      <div >        
        <div>
          <label className="block mb-2 text-blue-900">Location To</label>
      ...
      {/* Second Row: Approx Property Size and Property Type */}
      <Dropdown
