import {
  ...
  const BillingDetailsForm: React.FC<BillingDetailsFormProps> = ({ setFormData, formData }) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <FormControl fullWidth size="small">
              ...
              <Select sx={{ borderRadius: "12px", border: "1px solid #0D90C8" }} onChange={(e) => setFormData({ ...formData, country: (e.target.value as string) })}>
          ...
          <Grid item xs={6}>
            <FormControl fullWidth size="small">
              ...
              <Select sx={{ borderRadius: "12px", border: "1px solid #0D90C8" }} onChange={(e) => setFormData({ ...formData, province: (e.target.value as string) })}>
