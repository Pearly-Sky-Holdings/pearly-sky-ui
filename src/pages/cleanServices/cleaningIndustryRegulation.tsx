        ...
        <Grid container spacing={4} alignItems="stretch">
          ...
          <Grid item xs={12} md={5}>
            <Box
              component="img"
              src={readMoreImage1}
              alt={translate('cleaningRegulationImageAlt')}
              sx={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              {translate('cleaningRegulationTitle')}
            </Typography>

            <Typography paragraph sx={{ fontSize: "1.1rem" }}>
              {translate('cleaningRegulationIntro')}
            </Typography>
            ...
            >
              {translate('workerTrainingTitle')}
            </Typography>
            <Typography paragraph sx={{ fontSize: "1.1rem" }}>
              {translate('workerTrainingContent')}
            </Typography>
            ...
            <Typography
              ...
              sx={{ color: "#002F6D", fontWeight: "bold", mt: 2 }}
            >
              {translate('chemicalLabelingTitle')}
            </Typography>
            <Typography paragraph sx={{ fontSize: "1.1rem" }}>
              {translate('chemicalLabelingContent')}
            </Typography>
          </Grid>
        </Grid>
        <Typography
          ...
          sx={{ color: "#002F6D", fontWeight: "bold", mt: 2 }}
        >
          {translate('wastewaterTitle')}
        </Typography>
        <Typography paragraph sx={{ fontSize: "1.1rem" }}>
          {translate('wastewaterContent')}
        </Typography>
