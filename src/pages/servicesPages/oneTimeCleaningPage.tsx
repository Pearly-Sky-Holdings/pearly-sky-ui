    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-8 flex flex-col sm:flex-row gap-4 sm:gap-8">
        ...
        <div className="w-full sm:w-2/3">
          ...
          Basic cleaning also covers light organization, trash removal, and disinfecting common touch points such as 
          door handles and light switches. This service is ideal for people who need a quick refresh of their space or want it cleaned for an event or after a period of inactivity.
          </p>
        </div>
      </div>
