...
function RegularBasicCleaningPage() {
  ...
  const additionalServices = [
    ...
    { id: "kitchen-appliances", label: "Clean the Kitchen Appliances" },
    { id: "pet-areas", label: "Cleaning and Disinfect Pet Areas" },
    { id: "doors", label: "Cleaning Doors" },
    { id: "outdoor-furniture", label: "Cleaning Outdoor Furniture" },
    { id: "fan-fixtures", label: "Dust Cleaning Fan and Light Fixtures" },
    { id: "garden", label: "Garden Cleaning" },
    { id: "ironing", label: "Ironing" },
    { id: "laundry", label: "Laundry Service" },
    { id: "limescale", label: "Limescale removal" },
    { id: "mold", label: "Mold Removal" },
    { id: "organizing", label: "Organizing/Packing" },
    {
      id: "sweep",
      label: "Sweep and Mop outdoor areas such as porches and patio",
    },
    { id: "carpet", label: "Vacuum Carpet and Area Rugs" },
    { id: "carpet-drapes", label: "Vacuum Carpet and Drapes" },
    { id: "furniture", label: "Vacuum Furniture and Upholstery" },
    { id: "wall", label: "Wall Cleaning" },
    { id: "bed-linens", label: "Wash and Change Bed Linens" },
    { id: "window", label: "Window Cleaning (House & Apartment)" },
    {
      id: "fridge",
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
                ...
                {"price" in service && (
                  <div className="mt-1 text-xs text-gray-500">
                    {service.price !== undefined && (
                      <span>
                        C$ {service.price.toFixed(2)} {service.priceLabel}
                      </span>
                    )}
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            <label className="block mb-2 text-black">Contact Person Type</label>
            <select
              className="w-full border border-blue-900 rounded p-2 text-gray-400"
              value={frequency}
              onChange={(e) => setFrequency(e.target.value)}
